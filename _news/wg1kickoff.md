...
<h4>Program</h4>
<ul>
  <li>Welcome, Information on the COST Action and on WG 1, getting to know each other</li>
  <li>Scientific talks:
    <ul>
      <li>Patricia Pauli (TU Eindhoven)</li>
      <li>Domènec Ruiz-Balet (Universitat de Barcelona)</li>
    </ul>
  </li>
...
<ul>
  <li><a href="{{ site.baseUrl }}/files/wg1/kickoffWG1Announcement.pdf" target="_blank" rel="noopener noreferrer" class="link">Announcement slide</a></li>
  <li><a href="{{ site.baseUrl }}/files/wg1/kickoffWG1Presentation.pdf" target="_blank" rel="noopener noreferrer" class="link">Presentation</a></li>
</ul>
